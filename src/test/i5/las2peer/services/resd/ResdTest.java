package i5.las2peer.services.resd;
 ...
 * 7012 - Test Class
 *
 * This class provides a basic testing framework for the microservice 7012. It was
...
public class ResdTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Resd.class.getCanonicalName(),"0.1");

  private static final String mainPath = "resd";
